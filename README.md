...
# 📖 Hello Rails Api Only app <a name="about-project"></a>
...
```sh
  cd Folder
  git clone git@github.com:aamirkhan2478/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/aamirkhan2478/hello-rails-back-end/issues).
